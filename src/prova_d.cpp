...
void splitSingleDirection(const Object2d& face_pca, double& area_min, Point2d& cutting_point, int& best_cutting_direction, int cutting_direction) 
 { 
	...
	prova ad usare una variabile globale per tenere informazione se best_split ha davvero dimensione 2 o no. Nel nostro es ce il; caso che e zero quindi mi va in bratta
	il codice. 
