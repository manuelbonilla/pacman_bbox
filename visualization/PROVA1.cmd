...
variable set variable =.PISAIIT_HAND.dist_x real_value = 34.212544
variable set variable =.PISAIIT_HAND.dist_y real_value = 75.330243
variable set variable =.PISAIIT_HAND.dist_z real_value = 130.066265
