...
load('sim_info_cup_collision.mat')
load('sim_info_cup.mat')
...
for i=1:size(To_Adams_new,1)
    ...
    input = ['../build/cup/prova' num2str(i) '.req'];      %num2str(adams_indexes(i))
...
%         index_red=[index_red; i];
        ...
        fprintf(fileID,'%f\t%f\t%f\t%f\t%f\t%f\n', To_Adams_new(i,1)/1000, To_Adams_new(2,1)/1000, To_Adams_new(3,1)/1000, To_Adams_new(4,1), To_Adams_new(5,1), To_Adams_new(6,1));
