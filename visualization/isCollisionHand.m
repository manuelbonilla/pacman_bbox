function [ collision ] = isCollisionHand( ObjectMesh, T_hand )
...
collision_palm = isCollisionWithBox( ObjectMesh, T_hand, palm_box, [.110;.112;.028] );
...
collision_little = isCollisionWithBox( ObjectMesh, T_hand, little_box, [.017;.082;.028] );
...
collision_ring = isCollisionWithBox( ObjectMesh, T_hand, ring_box, [.017;.082;.028] );
...
collision_middle = isCollisionWithBox( ObjectMesh, T_hand, middle_box, [.017;.082;.028] );
...
collision_index = isCollisionWithBox( ObjectMesh, T_hand, index_box, [.017;.082;.028] );
...
collision_thumb = isCollisionWithBox( ObjectMesh, T_hand, thumb_box, [.017;.082;.028] );
